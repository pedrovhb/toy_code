...
function useSelector(store, selector, compare = defaultCompare) {
  ...
  return react.useSyncExternalStore(react.useCallback(handleStoreChange => store.subscribe(handleStoreChange).unsubscribe, [store]), () => selectorWithCompare(store.getSnapshot()), () => selectorWithCompare(store.getInitialSnapshot()));
}
